...
CREATE TABLE User (
    ...
    Phone VARCHAR(20) UNIQUE NOT NULL,
    Password VARCHAR(255) NOT NULL,
    UserType ENUM('Regular', 'VIP') NOT NULL CHECK (UserType IN ('Regular', 'VIP'))
);
...
CREATE TABLE Reservation (
    ...
    booking_date DATETIME NOT NULL CHECK (booking_date >= reservationDate),
...
CREATE TABLE Ticket (
    ...
    penaltyRate DECIMAL(10,2) NOT NULL CHECK (penaltyRate >= 0),
